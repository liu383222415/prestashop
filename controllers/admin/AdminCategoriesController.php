...
class AdminCategoriesControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->fields_list = array(
            ...
            'is_mobile_index_show' => array(
                'title' => $this->l('M home diasplay'),
                'active' => 'status',
                'type' => 'bool',
                'class' => 'fixed-width-xs',
                'align' => 'center',
    ...
    public function renderForm()
    {
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->l('M show index'),
                    'name' => 'is_mobile_index_show',
                    'required' => false,
                    'is_bool' => true,
                    'values' => array(
                        array(
                            'id' => 'mobile_index_show_on',
                            'value' => 1,
                            'label' => $this->l('Enabled')
                        ),
                        array(
                            'id' => 'mobile_index_show_off',
                            'value' => 0,
                            'label' => $this->l('Disabled')
                        )
                    )
