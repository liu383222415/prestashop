...
class AdminCmsControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->fields_list = array(
          ...
          //  'title' => array('title' => $this->l('Meta Title'), 'filter_key' => 'b!title'),
        ...
        $this->fields_form = array(
            ...
            'input' => array(
				...
				array(
                    ...
                    'label' => $this->l('博客页面图片'),
                    'name' => 'blog_image',
                    'id' => 'blog_image', // for copyMeta2friendlyURL compatibility
                    'lang' => true, 
    ...
    {	
        ...
        if (Tools::isSubmit('viewcms') && ($id_cms = (int)Tools::getValue('id_cms'))) {
			...
			if(isset($_FILES['blog_image'])){
				...
				$filepath = _PS_ROOT_DIR_ . '/img/blog_img/';
				if(move_uploaded_file($tmp,$filepath.$id_cms.".jpg")){
        ...
        elseif (Tools::getValue('submitDel'.$this->table)) {
			...
			if(isset($_FILES['blog_image'])){
                ...
                $file_name = '/img/blog_img/'.(time().'_'.$imgname);
                if(move_uploaded_file($tmp,$filepath.$file_name)){
